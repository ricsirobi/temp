...
public class UiDreadfallItemExchangeMenu : KAUIMenu
{
	private UiDreadfallItemExchange mDreadfallItemExchangeUi;

	protected override void Start()
	{
		base.Start();
		mDreadfallItemExchangeUi = _ParentUi as UiDreadfallItemExchange;
	}

	public override void OnDragStart(KAWidget inWidget)
	{
		base.OnDragStart(inWidget);
		if (mDreadfallItemExchangeUi != null)
		{
			mDreadfallItemExchangeUi.ItemPicked(inWidget);
		}
	}
	...
	public override void OnDragEnd(KAWidget inWidget)
	{
		...
		if (inWidget.GetUserData() != null && mDreadfallItemExchangeUi != null)
		{
			ClearDragItem();
			mDreadfallItemExchangeUi.ItemDropped(inWidget);
		}
	}
