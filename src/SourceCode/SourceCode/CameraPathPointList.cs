		...
		for (int j = 0; j < count; j++)
		{
			...
			case CameraPathPoint.PositionModes.Free:
				if (cameraPathPoint2.cpointA == cameraPathPoint2.cpointB)
				{
					...
					cameraPathPoint2.animationPercentage = (cameraPath.normalised ? cameraPathPoint2.point.normalisedPercentage : cameraPathPoint2.point.percentage);
				...
				cameraPathPoint2.animationPercentage = (cameraPath.normalised ? cameraPath.CalculateNormalisedPercentage(cameraPathPoint2.percent) : cameraPathPoint2.percent);
