...
public class UIWidget : UIRect
{
	...
	public Color pOrgColorTint
	{
		get
		{
			return mOrgColorTint;
		}
		set
		{
			mOrgColorTint = value;
	...
	public int pOrgDepth => mOrgDepth;
	...
	{
		base.Awake();
		mOrgPosition = base.cachedTransform.localPosition;
		mOrgScale = base.cachedTransform.localScale;
		mOrgColorTint = color;
		mOrgDepth = depth;
	...
	{
		base.cachedTransform.localScale = mOrgScale;
		color = mOrgColorTint;
	}
}
