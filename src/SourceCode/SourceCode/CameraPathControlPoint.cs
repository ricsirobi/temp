...
public class CameraPathControlPoint : MonoBehaviour
{
	...
	public Vector3 localPosition
	{
		...
		set
		{
			_position = Quaternion.Inverse(base.transform.rotation) * value;
		}
	}
	...
	public Vector3 worldPosition
	{
		get
		{
			return LocalToWorldPosition(_position);
		}
		set
		{
			_position = WorldToLocalPosition(value);
		}
	}
	...
	public Vector3 backwardControlPoint
	{
		get
		{
			Vector3 vector = (_splitControlPoints ? _backwardControlPoint : (-_forwardControlPoint));
