...
public class UiSnoggletogLootBox : KAUI
{
	[Serializable]
	...
	private List<string> mLootBoxAssets = new List<string>();
	...
	public void SetMessageObject(GameObject obj)
	{
		mMessageObject = obj;
	}
	...
	private void CloseUi()
	{
		...
		{
			mMessageObject.SendMessage("OnRedeemLootBoxClosed");
		}
